...
i=1
all_file_name_list = glob.glob('../answers_out/answer_14_out1_*.jpg')        #需更改answer_12_out 
for file_name in all_file_name_list:
    i=i+1
#str="../answers_out/answer_12_out"+str(i)+".jpg"
str1="../answers_out/"+str_write+"_answer_14_out1_"+str(i)+".jpg"              #需更改answer_12_out


j=1
strfolder="../answers_out/"+str_write+"_answer_14_out2_*.jpg"
all_file_name_list = glob.glob(strfolder)        #需更改answer_12_out 
for file_name in all_file_name_list:
    j=j+1

str2="../answers_out/"+str_write+"_answer_14_out2_"+str(j)+".jpg"              #需更改answer_12_out
