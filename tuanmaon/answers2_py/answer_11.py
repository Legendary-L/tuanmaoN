...
# motion filtering
out = mean_filter(img, K_size=3)                ###需更改

i=1
strfolder="../answers_out/"+str_write+"_answer_11_out1_*.jpg"
all_file_name_list = glob.glob(strfolder)        #需更改answer_12_out 
for file_name in all_file_name_list:
    i=i+1

str="../answers_out/"+str_write+"_answer_11_out1_"+str(i)+".jpg"              #需更改answer_12_out


# Save result
cv2.imwrite(str, out)
cv2.imshow("result", out)                                                   #待决定
cv2.waitKey(100)
